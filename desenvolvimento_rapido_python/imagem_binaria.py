...
if imagem_cinza is None:
	raise FileNotFoundError("A imagem '666ac145-a811-4295-80d1-72f57b053146.jpeg' não foi encontrada ou não pôde ser carregada.")
...
cv2.imwrite('666ac145-a811-4295-80d1-72f57b053146_binaria.jpeg', imagem_binaria)  # Salva a imagem binária
cv2.imshow('Binária', imagem_binaria)              # Mostra na tela
cv2.waitKey(0)
cv2.destroyAllWindows()

# Removido porque 'arquivo' não foi definido
